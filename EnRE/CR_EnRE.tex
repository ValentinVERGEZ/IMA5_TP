...
%__Informations pour le document__%
  \title{\textsc{\textbf{TP - Énergies renouvelables}} - IMA5\\~\\
  \Large{\textit{Simulation d'un système de pompage photovoltaïque}}
  }
  \date{}
  \author{
...
\include{includes/REM}
\include{includes/SMC}
\include{includes/Strategie}
\include{includes/conclu}
%_Annexes	
	\appendix
	%\appendixpage
	\addappheadtotoc
\input{includes/annexes}
