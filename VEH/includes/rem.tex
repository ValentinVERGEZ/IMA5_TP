...
Dans ce TP, nous ne gérons pas le rapport de la boite de vitesse contrairement aux voitures hybrides réelles. Le rapport est donc une donnée d'entrée de notre point de vu. Nous n'aurons qu'à utiliser ce rapport pour déterminer le ratio et le rendement de la vitesse sélectionnée. 
\vspace{-10px}
\begin{figure}[ht]
\centering
\begin{minipage}{.5\textwidth}  
...
\newpage
\subsection{Poulie}
La poulie est montée sur l'arbre du moteur thermique. Afin de diminuer le volume du moteur électrique, on choisi un moteur moins coupleux mais tournant plus vite. Le ratio permet de ramener cette vitesse dans une gamme utilisable pour cette application.
\vspace{-20px}
\begin{figure}[ht]
\centering
\begin{minipage}{.5\textwidth}  
