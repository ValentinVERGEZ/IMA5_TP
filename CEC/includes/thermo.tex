...
%Tout d'abord, il faut déterminer la valeur des pertres fers totales. Pour cela nous allons caluler cette valeur de deux manière différentes. 
...
Nous avons choisi un certain matériau pour faire les taôls il s'agi.
...
%schéma courbe ou courbe réelle inserer en parallèle du texte.
