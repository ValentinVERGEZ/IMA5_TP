...
Nous choisissons donc la section apportant la masse la plus faible et après la résolution de l'équation de dimensionnement, nous obtenons les côtes suivantes : \\
\begin{itemize}
